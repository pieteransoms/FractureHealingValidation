...
cell_data = {'perfusion': [initialZeros], 'cartConc': [initialZeros], 'softCartConc': [initialZeros], 'mnrlCartConc': [initialZeros], 'wovBoneConc': [initialZeros], 'mnrlCart+BoneConc': [initialZeros], 'connTissConc': [initialOnes], 'distStrain': [initialZeros], 'dilaStrain': [initialZeros], 'elemVolume': [callusElemVolumes]}
